 ...
 */
export async function decryptData(packageStr: string, password: string): Promise<string> {
    try {
...
async function deriveKey(passwordKey: CryptoKey, salt: Uint8Array, keyUsage: ["encrypt"] | ["decrypt"]): Promise<CryptoKey> {
