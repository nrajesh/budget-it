...
export const getWebDirectoryHandle = async (): Promise<FileSystemDirectoryHandle> => {
    if (!('showDirectoryPicker' in window)) {
        throw new Error("Your browser does not support local folder sync. Please use Chrome, Edge, or the Budget-It desktop app.");
    }
