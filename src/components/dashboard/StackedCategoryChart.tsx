...
export const StackedCategoryChart = ({ transactions, className }: StackedCategoryChartProps) => {
    ...
    const { data, subCategories } = useMemo(() => {
        ...
        const chartData = Array.from(categoryMap.entries()).map(([category, subMap]) => {
    ...
    return (
        <Card className={className}>
            <CardHeader>
                ...
                <CardDescription>Top spending categories broken down by sub-category</CardDescription>
            </CardHeader>
            <CardContent>
