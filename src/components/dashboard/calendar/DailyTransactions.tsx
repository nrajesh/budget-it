                                ...
                                return (
                                    <div
                                        ...
                                        className={cn(
                                            ...
                                            isProjected && "opacity-70 italic text-slate-500 bg-slate-50/50 dark:bg-slate-900/50 border-dashed"
                                        )}
                                    >
                                        ...
                                        {impact && !isTransfer && (
                                            <div
                                                className={cn(
                                                    ...
                                                    isProjected && "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400"
                                                )}
                                            >
                                                <span>
