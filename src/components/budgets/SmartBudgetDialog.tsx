    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            We analyzed your past transactions and found these top spending
            categories. Adjust the proposed monthly amounts and select the
            budgets you want to create.
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="max-h-[400px] overflow-y-auto">
                {suggestions.length === 0 ? (
                  <div className="p-8 text-center text-muted-foreground">
                    Not enough data to make suggestions. Upload more
                    transactions!
                  </div>
                ) : (
                  suggestions.map((item, idx) => (
                    <div
                      key={idx}
                      className={`grid grid-cols-12 gap-4 p-4 items-center border-b last:border-0 ${item.isSelected ? "bg-card" : "opacity-50"}`}
                    >
                      <div className="col-span-1 flex justify-center">
                        <Checkbox
                      ...
                      <div className="col-span-2 text-right text-sm text-muted-foreground">
                        {item.averageSpend.toLocaleString("en-US", {
                          style: "currency",
