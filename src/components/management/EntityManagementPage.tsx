...
interface EntityManagementPageProps<T extends { id: string; name: string }> {
  ...
  AddEditDialogComponent?: React.FC<{ isOpen: boolean; onOpenChange: (open: boolean) => void; payee?: T | null }>;
  ...
  DeduplicationDialogComponent?: React.FC<{ isOpen: boolean; onClose: () => void; }>;
  CleanupDialogComponent?: React.FC<{ isOpen: boolean; onClose: () => void; }>;
  BalanceReconciliationDialogComponent?: React.FC<{ isOpen: boolean; onClose: () => void; }>;
  groupBy?: keyof T;
}
...
const EntityManagementPage = <T extends { id: string; name: string }>({
  ...
  TableComponent?: React.ComponentType<{ data: T[]; columns: ColumnDefinition<T>[]; isLoading: boolean; selectedRows: string[]; handleRowSelect: (id: string, checked: boolean) => void; handleEditClick: (item: T) => void; handleDeleteClick: (item: T) => void; isDeletable: (item: T) => boolean; isEditing: (id: string) => boolean; isUpdating: boolean; groupBy?: keyof T; }>;
}) => {
