    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between mb-4">
          <h3 className="text-sm font-medium tracking-wider uppercase text-slate-500 dark:text-white/60">
            {title}
          </h3>
          {icon && (
            <div className="p-2 rounded-full bg-slate-100/80 text-slate-500 dark:bg-white/5 dark:text-white/40">
              {icon}
            </div>
          )}
        </div>
