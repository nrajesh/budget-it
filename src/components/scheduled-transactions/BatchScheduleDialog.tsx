...
interface BatchScheduleDialogProps {
    ...
    count: number;
    onConfirm: (settings: { frequency_value: number, frequency_unit: string, date: string }) => void;
}

export function BatchScheduleDialog({ isOpen, onOpenChange, count, onConfirm }: BatchScheduleDialogProps) {
    ...
    const handleConfirm = () => {
        onConfirm({ frequency_value: frequencyValue, frequency_unit: frequencyUnit, date });
        onOpenChange(false);
    };
        ...
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        These transactions will be converted into recurrent scheduled transactions.
                    </DialogDescription>
                </DialogHeader>
