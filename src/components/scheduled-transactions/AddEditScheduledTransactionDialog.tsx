...
export const AddEditScheduledTransactionDialog: React.FC<AddEditScheduledTransactionDialogProps> = ({
  ...
  useEffect(() => {
    if (scheduledTransaction) {
      form.reset({
        date: new Date(scheduledTransaction.date), // Convert string to Date object
        ...
        recurrence_end_date: scheduledTransaction.recurrence_end_date ? new Date(scheduledTransaction.recurrence_end_date) : null, // Convert string to Date object
