...
const mockAccountCurrencyMap = new Map([['Account 1', 'USD'], ['Account 2', 'EUR']]);
const mockAccounts = [
    { id: '1', name: 'Account 1' },
    { id: '2', name: 'Account 2' }
];
...
describe('useTransactionFormLogic', () => {
    ...
    it('should initialize with default values when no transactionToEdit is provided', () => {
        const { result } = renderHook(() => useTransactionFormLogic({ isOpen: true }));
    ...
    it('should initialize with transaction values when transactionToEdit is provided', () => {
        ...
        const { result } = renderHook(() => useTransactionFormLogic({
            transactionToEdit,
            isOpen: true
        }));
