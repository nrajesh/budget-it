...
>(({ className, children, ...props }, ref) => {
  return (
    <Card ref={ref} className={cn(GLASS_CARD_CLASS, className)} {...props}>
      {children}
    </Card>
  );
});
...
>(({ className, ...props }, ref) => {
  return (
    <CardHeader
      ref={ref}
      className={cn(GLASS_HEADER_CLASS, className)}
      {...props}
    />
  );
});
...
>(({ className, ...props }, ref) => {
  return (
    <CardTitle
      ref={ref}
      className={cn(GLASS_TITLE_CLASS, className)}
      {...props}
    />
  );
});
...
>(({ className, ...props }, ref) => {
  return (
    <CardDescription
      ref={ref}
      className={cn(GLASS_DESCRIPTION_CLASS, className)}
      {...props}
    />
  );
});
