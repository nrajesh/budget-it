...
const ScheduledTransactionsPage = () => {
  ...
  return (
    <div className="flex-1 space-y-6 sm:p-6 p-4 rounded-xl min-h-[calc(100vh-100px)] transition-all duration-500 bg-slate-50 dark:bg-gradient-to-br dark:from-gray-900 dark:via-slate-900 dark:to-black overflow-x-hidden">
